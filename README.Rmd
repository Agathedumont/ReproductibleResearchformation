...
Launch the [`make.R`](https://github.com/Agathedumont/exercice_compendium/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/Agathedumont/exercice_compendium/blob/main/CONTRIBUTING.md).
